...
st.set_page_config(
    ...
    menu_items={
        "Report a bug": "https://github.com/ikppramesh/BuildshortVideos/issues",
        "About": "# BuildshortVideos\nSimply provide a topic or keyword for a video, and it will "
        "automatically generate the video copy, video materials, video subtitles, "
        "and video background music before synthesizing a high-definition short "
        "video.\n\nhttps://github.com/ikppramesh/BuildshortVideos",
    },
)


# Streamlit 1.59 会在页面右上角默认展示 Deploy、skills nudge 等平台入口。
# BuildshortVideos is a local end-user tool; these entry points cause a large blank space at the top,
...
ONBOARDING_TOUR_KEY = "bsv-onboarding-v1"
VOICE_MODE_TTS = "tts"
...
def _render_brand(available_update: str | None = None):
    ...
    st.markdown(
        f"""
        <h1 class="bsv-brand">
            <span class="bsv-brand__name">BuildshortVideos</span>
            <a class="bsv-brand__version"
               href="https://github.com/ikppramesh/BuildshortVideos"
               target="_blank"
               rel="noopener noreferrer"
               aria-label="Open BuildshortVideos on GitHub"
