"""检查 BuildshortVideos 是否存在可用的新正式版本。"""
...
LATEST_RELEASE_API_URL: Final = (
    "https://api.github.com/repos/ikppramesh/BuildshortVideos/releases/latest"
)
LATEST_RELEASE_PAGE_URL: Final = (
    "https://github.com/ikppramesh/BuildshortVideos/releases/latest"
)
...
RELEASE_CHECK_HEADERS: Final = {
    ...
    "User-Agent": "BuildshortVideos-Version-Checker",
}
...
def get_available_update(current_version: str) -> str | None:
    ...
    logger.info(
        "BuildshortVideos update available: "
...
class AsyncUpdateChecker:
    ...
    def _run_check(self, current_version: str) -> None:
        try:
            ...
            logger.exception(
                "unexpected error while checking for a BuildshortVideos update"
            )
